...
function getProgramProfile() {
    ...
    if (!db._settings.appProfile.specialization || db._settings.appProfile.specialization === 'أستاذ الرياضيات' || db._settings.appProfile.specialization === 'مدرس لغة إنجليزية') {
    ...
    if (!db._settings.appProfile.teacherName || db._settings.appProfile.teacherName === 'نظام إدارة الدروس' || db._settings.appProfile.teacherName === 'سنتر العباقرة' || db._settings.appProfile.teacherName === 'مستر محمد سليمان') {
        db._settings.appProfile.teacherName = 'محمد سيد';
    }
    if (!db._settings.appProfile.centerName || db._settings.appProfile.centerName === 'نظام إدارة الدروس' || db._settings.appProfile.centerName === 'سنتر العباقرة' || db._settings.appProfile.centerName === 'مستر محمد سليمان') {
        db._settings.appProfile.centerName = 'محمد سيد';
    }
...
function getTeacherDisplayName() {
    ...
    return (profile.teacherName && profile.teacherName.trim()) ? profile.teacherName.trim() : 'محمد سيد';
}
